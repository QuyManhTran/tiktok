export function UploadIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
            ...
            fill="currentColor"
        >
            <path d="M15.4,28.2a1.9,1.9,0,0,0,3,.2L22,24.8V36a2,2,0,0,0,4,0V24.8l3.6,3.6a1.9,1.9,0,0,0,3-.2,2.1,2.1,0,0,0-.2-2.7l-7-6.9a1.9,1.9,0,0,0-2.8,0l-7,6.9A2.1,2.1,0,0,0,15.4,28.2Z" />
...
export function InboxIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function HomeIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function HomeActiveIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function FollowingActiveIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function FollowingIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function LiveIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function LiveActiveIcon({ className, height = '32px', width = '32px' }) {
    return (
        <svg
            width={width}
            height={height}
...
export function MusicIcon({ className, height = '14px', width = '14px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function BrokenHeartIcon({ className, height = '20px', width = '20px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={height}
            ...
            className={className}
        >
            <path d="M3 17.54C3 10.32 8.36 4.5 15.86 4.5c3.96 0 6.64 2 7.37 2.94.73.94.77 1.56.8 1.8.02.56-.02 1.11-.05 1.67l-.59 3.5 3.74 3.27c.34.3.44.8.24 1.2l-2.42 4.84 1.7 3.72a1 1 0 0 1-.5 1.33l-1.83.83a1 1 0 0 1-1.32-.5l-2.28-5.03a1 1 0 0 1 .01-.86l2.02-4.04-3.06-3.05a1 1 0 0 1-.29-.83l.6-4.84c.09-1.46-3.15-1.95-4.14-1.95C10.69 8.5 7 12.4 7 17.54c0 2.96 1.26 5.9 3.3 8.77a49.16 49.16 0 0 0 7.34 7.85c1.89 1.7 3.9 3.46 6.14 4.66.2.1.23.11.43 0 2.25-1.2 4.25-2.99 6.16-4.67a46.9 46.9 0 0 0 7.36-7.83c2.03-2.87 3.27-5.8 3.27-8.78 0-5.14-3.69-9.04-8.86-9.04-.78 0-1.48.09-2.12.23a1.1 1.1 0 0 1-1.29-.67l-.65-1.9a.94.94 0 0 1 .64-1.23 13.6 13.6 0 0 1 3.42-.43C39.64 4.5 45 10.32 45 17.54c0 4.1-1.71 7.85-4 11.09a50.8 50.8 0 0 1-7.99 8.53c-2.3 2.01-4.9 4.53-7.83 5.62-.79.3-1.57.3-2.36 0-2.93-1.08-5.56-3.6-7.84-5.63a53.04 53.04 0 0 1-7.94-8.52C4.74 25.4 3 21.65 3 17.54Z"></path>
        </svg>
    );
}

export function ReportIcon({ className, height = '20px', width = '20px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={height}
...
export function HeartIcon({ className, height = '24px', width = '24px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function CommentIcon({ className, height = '24px', width = '24px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function FavoriteIcon({ className, height = '24px', width = '24px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
...
export function ShareIcon({ className, height = '24px', width = '24px' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
...
export function EmbedIcon({ className, height = '26px', width = '26px' }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export function SendIcon({ className, height = '26px', width = '26px' }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export function FacebookIcon({ className, height = '26px', width = '26px' }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export function WhatsAppIcon({ className, height = '26px', width = '26px' }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export function CopyLinkIcon({ className, height = '26px', width = '26px' }) {
    return (
        <svg
            width="26"
            data-e2e=""
